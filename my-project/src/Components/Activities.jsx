...
const Activities = () => {
    ...
    return (
        <div id="Activities" className="p-20 flex flex-col items-center justify-center">
         <h1 data-aos="fade-right"className="text-[70px] font-semibold mb-8 leading-normal uppercase text-white">Actividades</h1>
         <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid cols-1 justify-around gap-20">
            <h2 data-aos="fade-up"className="text-[26px] flex items-center justify-center font-semibold text-teal-500 rounded-3xl h-36 w-44 border-2 border-emerald-600 b_glow">Natación</h2>
            <h2 data-aos="fade-down"className="text-[26px] flex items-center justify-center font-semibold text-teal-500 rounded-3xl h-36 w-44 border-2 border-emerald-600 b_glow">Basquetball</h2>
            ...
            <h2 data-aos="fade-down"className="text-[26px] flex items-center justify-center font-semibold text-teal-500 rounded-3xl h-36 w-44 border-2 border-emerald-600 b_glow">Softball</h2>
