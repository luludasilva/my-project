    ...
    return (
        <div className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-20 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-50 items-center">
            <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
                <h1 className="text-[55px] font-semibold mb-8 leading-normal">Bienvenidos a <span className="text-teal-500 "> INTEGRA SPORT</span></h1>
                <p>Somos una escuela multideportiva dirigida exclusivamente a niños y adolescentes con discapacidad.<span></span>
            ...
            <img src={img} width={290} height={290} className="rounded-full border-2 p-1 border-emerald-600 img_glow" alt=""/>
        </div>
    );
};
