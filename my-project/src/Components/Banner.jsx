    ...
    return (
        <div className="lg:px-56 px-10 lg:py-0 py-10 text-center gap-20 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-50 items-center">
            <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
                ...
                <p data-aos="fade-right" className="text-justify">Somos una escuela multideportiva dirigida exclusivamente a niños y adolescentes con discapacidad. Formada por Profesores de Educación Física, que trabajan de forma independiente y en diferentes instituciones, brindando iniciación en actividades acuáticas y multiderportivas. <br />
